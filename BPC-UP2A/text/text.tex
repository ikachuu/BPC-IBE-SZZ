...
\subsection{Získavanie dát od ISP (poskytovateľ informačných služieb)}
Dáta, ktoré môžu byť zdrojom dôkazov pri trestnom konaní môžu byť získavané aj priamo od poskytovateľov informačných služieb. Poskytovatelia služieb sa dajú rozdeliť na dve skupiny:

\begin{enumerate}
    \item \textbf{Poskytovateľ telekomunikačných služieb}- podľa zákona 127/2005 Sb. o elektronických komunikáciách- myslí sa tým podnikateľ zaisťujúci verejnú komunikačnú sieť alebo poskytujúci verejne dostupnú službu elektronických komunikácií -> subjekty, ktoré prevádzkujú infraštruktúru verejnej komunikačnej siete alebo k nej priamo poskytujú pripojenie.
    \item \textbf{Poskytovateľ informačných služieb}- subjekt, ktorý elektronickými prostriedkami (pomocou komunikačnej siete) poskytuje akúkoľvek službu za úplatok na individuálnu žiadosť užívateľa podanú elektronickými prostriedkami. Sú to služby, ktoré pracujú s užívateľskými dátami- sociálne siete, hosting, cloud, emailové služby...
\end{enumerate}

Rôzne dáta podliehajú rôznej miere ochrany, preto je dôležité zvoliť dobré procesné nástroje. Podľa charakteru dát užívateľov spracovávaných poskytovateľom informačných služieb sa dáta dajú rozdeliť na:
\begin{itemize}
    \item \textbf{Obsahové dáta}- tie, ktoré počas využívania služby vložil užívateľ
    \item \textbf{Obsahové dáta o komunikácii užívateľa}
    \item \textbf{Lokalizačné údaje}
    \item \textbf{Prevádzkové údaje}
    \item \textbf{Rôzne iné metadáta}
\end{itemize}

\noindent Pokiaľ sú od poskytovateľa služby vyžadované dáta neobsahujúce informácie, ktoré sú predmetom povinnosti o mlčanlivosti, je tento poskytovateľ povinný vyhovieť dožiadaniam orgánov v trestnom konaní pri vykonávaní ich požiadaviek. Týmto postupom je možné získať dáta ako: dáta, ktoré užívateľ zverejnil, informácie o užívateľských účtoch, logy zaznamenávané poskytovateľom a rôzne iné metadáta. Okrem týchto dát sa týmto spôsobom môžu vyžadovať aj dáta charakteru lokalizačných služieb a prevádzkových služieb, ktoré ale nesmú obsahovať osobné údaje alebo utajované informácie. Pokiaľ sa jedná o dáta zabezpečené bezpečnostným opatrením majú tieto dáta charakter záznamov uchovávaných v súkromí a je potrebné postupovať iným spôsobom.

\textbf{Prevádzkové a lokalizačné údaje} majú v zmysle §90 a §91 zákona o elektronických komunikácí špecifické postavenie. Ide o údaje spracovávané pre potrebu prenosu správ alebo pre účtovné spracovanie. Ide taktiež o údaje spracovávané v sieti elektronických komunikácií alebo službou elektronických komunikácií, ktoré určujú zemepisnú polohu telekomunikačného koncového zariadenia užívateľa. Tieto údaje má poskytovateľ za podmienok stanovených v zákone o elektronických komunikacích povinnosť na určitú dobu uchovávať. K týmto dátam sa pristupuje za špecifických podmienok upravených v §88a zákona č. 141/1961 Sb. a je možné k nim pristupovať na nariadenie sudcu na návrh štátneho zástupcu. 

Na \textbf{dáta, ktoré sú obsahom telekomunikačného provozu}- dáta, ktoré sú pomocou siete komunikované sa vzťahuje telekomunikačné tajomstvo. Odposluch alebo zachytávanie komunikácie je možné jedine za podmienok stanovených v §88 zákona č. 141/1961 Sb. Rovnako je na využitie tohto procesného nástroja potrebné nariadenie sudcu na návrh štátneho zástupcu.
